...
async function loadSubmission() {
    ...
    try {
        const response =
            await axios.get<GradingResponse>(
        ...
        remarks.value =
            submission.value.grade?.remarks ?? '';
    } catch (error) {
 ...
 */
function isIncorrectStudentChoice(
    choice: Choice,
): boolean {
    return (
        choice.is_selected &&
...
<template>
    ...
    <div
        v-else
        class="flex h-full max-w-4xl flex-1 flex-col gap-6 p-4"
    >
        <!-- ============================================================ -->
        <!-- Header -->
        <!-- ============================================================ -->
            ...
            <div class="space-y-4">
                ...
                <div
                    v-if="
                        ...
                        'essay'
                    "
                    class="min-h-[200px] whitespace-pre-wrap rounded-xl border p-4 text-sm leading-relaxed"
                >
                    {{
                        submission.content ||
                        '(No content)'
                ...
                >
                    <pre
                        class="overflow-x-auto whitespace-pre-wrap font-mono text-sm text-green-400"
                ...
                >
                    ...
                    >
                        No questions were found for this
                        submission.
                    </div>
